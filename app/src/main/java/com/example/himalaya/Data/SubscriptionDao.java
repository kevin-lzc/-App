...
public class SubscriptionDao implements ISubDao{
    ...
    public void addAlbum(Album album) {
        ...
        try{
            ...
            contentValues.put(Constants.SUB_TRACKS_COUNT,album.getAlbumIntro());
            contentValues.put(Constants.SUB_DESCRIPTION,album.getIncludeTrackCount());
            contentValues.put(Constants.SUB_TRACKS_COUNT,album.getPlayCount());
